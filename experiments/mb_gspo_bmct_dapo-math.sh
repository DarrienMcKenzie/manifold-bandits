...
## Experiment
PROJECT_NAME='mma'
EXP_NAME='MB_GSPO_BMC-T_DAPO-Math_Qwen3-8B-Base'
EPOCHS=8 
CKPTS_DIR='volume'
...
TARGET_FILE='data/math_eval.parquet' # could change this to be anything. subsets of the test, for instance
