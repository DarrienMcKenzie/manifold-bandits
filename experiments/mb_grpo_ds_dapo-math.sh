...
# Experiment
PROJECT_NAME='mma'
EXP_NAME='MB_GRPO-US_DAPO-Math_Qwen3-4B-Base'
EPOCHS=8
CKPTS_DIR='volume'
...
USE_KL_LOSS=True # use for GRPO
USE_KL_IN_REWARD=False 
KL_COEF=0.001 # not used for GRPO (set just in case I guess)
KL_LOSS_COEF=0.001
...
python -m main_dapo \
    ...
    actor_rollout_ref.actor.clip_ratio=${CLIP_RATIO_HIGH} \
